...
@section('titulo','Aula ' . $aula->nombre)
...
@section('contenido-header')
	<div class="row justify-content-between py-4">
		<div class="col-12">
			<h1 class="text-white text-center">Aula {{ $aula->nombre }}</h1>
		</div>
	</div>
@endsection
					...
					<div class="col-auto">
						<table class="table">
							...
							<tr>
								...
								<td><span class="h3">{{ $aula->nombre }}</span></td>
							</tr>
							<tr>
								<td><span class="h3">Status:</span></td>
								<td>
									<i class="fas fa-circle {{ $aula->status ? 'text-success' : 'text-danger' }} mr-1"></i>
									<span class="h3">{{ $aula->status ? 'Activo' : 'Inactivo' }}</span>
								</td>
							</tr>
							</tbody>
						</table>
